...
function ControlledCarousel() {
    return (
        ...
        <Carousel.Item interval={14000}>
            ...
            <p>The company is founded on the principle that while clients have unique needs that require custom solutions - they can be built using standard components in a cloud native and largely vendor agnostic fashion. We do not believe in reinventing the wheel.</p>
            </Carousel.Caption>
        </Carousel.Item>
        <Carousel.Item interval={14000}>
            <img
